...
rawPath           = "/Volumes/observability_prd/raw/ecs-observability-datadog-logging-prd/auth/front/"
bronzePath        = f"auth_prd.bronze.tb_{source}_front"
bronzeCheckpoint  = f"/Volumes/auth_prd/bronze/checkpoints/ecs-datalakehouse-prd-checkpoints/ecs/auth/{source}/front"
...
for i in range(len(start_dates)):
  ...
  rawDF = (
    spark.readStream.format("json")
            .schema(schema_bronze_front)
            .options(maxFilesPerTrigger=5000)
            .load(rawPathDay)
)
